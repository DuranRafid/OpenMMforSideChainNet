...
class StructureMinimizer(object):
    ...
    def minimize(self,  max_Iterations=100, tolerance = 30): # Tolerance : Number of times it tries to decrease loss once loss stops decreasing
        if max_Iterations==-1:
...
if __name__ == '__main__':
    ...
    sm.minimize(max_Iterations=-1) #When set to -1 it finds the local minima irrespective of the number of iterations
